...
<body>
    <div class="register-photo" style="background-color: #3aafa9;">
        <div class="form-container">
            ...
            <form method="post" action="includes/manage_doctors.php" style="font-family: 'Abril Fatface', cursive;width: 320px;background-color: #def2f1;">
                <h2 class="text-center" style="font-family: 'Abril Fatface', cursive;font-size: 41px;">Register Now!!
                </h2>
                <div class="form-group"><input class="form-control" name="username" type="text" placeholder="Username"></div>
                <div class="form-group"><input class="form-control" name="name" type="text" placeholder="Name"></div>
                <div class="form-group"><input class="form-control" name="phone_no" type="number" placeholder="Contact"></div>
                <div class="form-group">
                    <label for="hosp" style="font-size: 14px;">CHOOSE HOSPITAL:</label>
                    <select id="hosp" name="hosp_name" style="width: 80px;">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit"
                        style="font-family: 'Abril Fatface', cursive;background-color: #17252a;color: #feffff;font-size: 25px;">Sign
                        Up</button></div>
            </form>
        </div>
    </div>
