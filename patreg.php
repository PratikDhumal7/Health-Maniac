...
<body>
    <div class="register-photo" style="background-color: #3aafa9;">
        <div class="form-container">
            ...
            <form method="post" action="includes/manage_patients.php" style="font-family: 'Abril Fatface', cursive;width: 320px;background-color: #def2f1;">
                <h2 class="text-center" style="font-family: 'Abril Fatface', cursive;font-size: 41px;">Register Now!!</h2>
                ...
                <div class="form-group"><input class="form-control" name="name" placeholder="Name" type="text">
                    <input class="form-control" type="text" name="address" placeholder="Address" style="margin-top: 12px;"></div>
                <div class="form-group"><input class="form-control" name="phone_no" placeholder="Contact" type="number"></div>
                <div class="form-group"><input class="form-control" name="email" placeholder="Email" type="email"></div>
                <div class="form-group"><input class="form-control"  name="gender" placeholder="Gender" type="text"></div>
                <div class="form-group"><input class="form-control" name="dob" placeholder="DOB" type="date"></div>
